// <?php include_once("./ahk_loaders.php"); ?>  
...
(function () {
	...
	$(function () {
		...
		var lineChart,
				lineChartObject = {
					...
					data: {
						x: 'x',
						columns: [
							['x', '2013-01-01', '2013-06-01', '2014-01-01', '2014-05-01', '2015-01-01', '2015-06-01', '2016-05-01', '2019-01-01', '2019-06-01', '2019-09-01'],
					...
					axis: {
						x: {
							...
							min: '2012-01-01',
							max: '2019-01-01',
							values: [2013, 2014, 2015, 2016, 2017, 2019],
							tick: {
								format: '%Y',
								outer: false
							},
		...
		Custom Radios
		 */
		$('.form-check-inline').first().find('input').attr('checked', true);
		$('.form-input-radio').on('focus', function () {
